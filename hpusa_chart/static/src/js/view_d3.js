openerp.hpusa_chart = function(instance) {
    ...
    instance.web.views.add('chart-d3', 'instance.hpusa_chart.ChartD3View');

    instance.hpusa_chart.ChartD3View = instance.web.View.extend({
        events: {
