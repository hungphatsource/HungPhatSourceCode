...
class product_product(osv.osv):
    ...
    _columns = {
        ...
        'maximum_discount': fields.float('Maximum Discount (%)', digits=(16, 2), readonly=False),
        'buffer_days': fields.float('Buffer days', digits=(16, 2), readonly=False),
        'typeproduct': fields.selection([('diamon','Diamon'),('jewelry','Jewelry')],'Categories'),
