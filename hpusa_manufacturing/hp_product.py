...
class product_product(osv.osv):
    ...
    _columns = {
        ...
        'jewelry_class_id': fields.many2one("product.jewelry.class", "Jewelry Class"),
        'jewelry_subclass_id': fields.many2one("product.jewelry.subclass","Jewelry Sub-Class")
...
class product_finish_class(osv.osv):
    _name = "product.jewelry.class"
    
    _description="Jewelry Class"
    
    _columns = {
        'name': fields.char('Name', required=True),     
    }
product_finish_class()

class product_finish_subclass(osv.osv):
    _name = "product.jewelry.subclass"
    
    _description="Jewelry Sub Class"
    
    _columns = {
        'name': fields.char('Name', required=True),     
    }
product_finish_subclass()
