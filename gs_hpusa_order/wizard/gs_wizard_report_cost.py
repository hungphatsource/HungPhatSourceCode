...
class gs_wizard_report(osv.osv_memory):
    ...
    def _get_context(self, cr, uid, context=None):
        ...
        total = [0.00,]
        sub = [0.00,]
        def get_bom(product_id,pricelist_id,quantity, quantity_product):
            res = {}
            pricelist_obj = self.pool.get('product.pricelist')
            bom_obj = self.pool.get('mrp.bom')
            product_uom = self.pool.get('product.uom')

            # hpusa confgure 27-05-2015
            von=0
            ...
            for bom in bom_obj.browse(cr, uid, [bom_id]):
                for bom_line in bom.bom_lines:
                    ...
                    if cost_price > 0:
                        ...
                        sub_1 = ((quantity_bom*price - quantity_bom*cost_price)/(quantity_bom*cost_price))*100 or 0.0


                    str_bom.append('<tr align="left" width="100%">'\
                  '<td width="150px" style=" background-color: rgb(245, 245, 245) ; vertical-align:top; margin-top:5px;"><li>'+str(bom_line.product_id.default_code)+'</li></td>'\
                  ...
                  '<td width="108px" style="background-color: rgb(245, 245, 245) ; vertical-align:top"><div align = right>'+str(locale.format('%0.2f',cost_price,True))+object.pricelist_id.currency_id.symbol+'</div></td>'\
                  '<td width="108px" style="background-color: rgb(245, 245, 245) ; vertical-align:top"><div align = right>'+str(locale.format('%0.2f',(quantity_bom/quantity_product)*cost_price,True))+object.pricelist_id.currency_id.symbol+'</div></td>'\
                  '<td width="108px" style="background-color: rgb(245, 245, 245) ; vertical-align:top"><div align = right>'+str(locale.format('%0.2f',(quantity_bom)*cost_price,True))+object.pricelist_id.currency_id.symbol+'</div></td>'\
                  ...
                  '<td width="40px" style="background-color: rgb(245, 245, 245) ; vertical-align:top"><div align = right>'+str(locale.format('%0.2f',total_1,True))+'</div></td>'\
                  '<td width="60px" style="background-color: rgb(245, 245, 245) ; vertical-align:top"><div align = right>'+str(round(sub_1,2))+'</div></td>'\
                  '</tr>')
                    #print 'margin sale' + str(total_1) + 'price' + str(quantity_bom*price)

                    #get_bom(bom_line.product_id.id,pricelist_id,quantity,quantity_product)
        for line in object.order_line:
            if line.check_ == True:
                str_bom = []
                get_bom(line.product_id.id,line.order_id.pricelist_id, line.product_uom_qty, line.product_uom_qty)
                total_1 = 0.00
                sub_1 = 0.00
                if len(total) > 0 and total[0] > 0:
                    total_1 = ((line.price_unit - total[0])/total[0])*100
                    sub_1= ((line.price_unit * line.product_uom_qty -line.dicount_number - sub[0])/sub[0])*100 or 0.0
                print 'test view BOM: ' + str(sub_1)
                str_line += '<tr align="left" style="vertical-align:top;" width="100%">'\
                  ...
                  '<td width="150px" style=" background-color: rgb(245, 245, 245) ; vertical-align:top; margin-top:5px;">'+str(line.product_id.default_code)+'</td>'\
                  ...
                  '<td width="90px" style="background-color: rgb(245, 245, 245) ; vertical-align:top"><div align = right>'+str(locale.format('%0.2f',line.dicount_number,True))+object.pricelist_id.currency_id.symbol+'</div></td>'\
                  '<td width="108px" style="background-color: rgb(245, 245, 245) ; vertical-align:top"><div align = right>'+str(locale.format('%0.2f',unit[0],True))+object.pricelist_id.currency_id.symbol+'</div></td>'\
                  '<td width="108px" style="background-color: rgb(245, 245, 245) ; vertical-align:top"><div align = right>'+str(locale.format('%0.2f',total[0],True))+object.pricelist_id.currency_id.symbol+'</div></td>'\
                  '<td width="108px" style="background-color: rgb(245, 245, 245) ; vertical-align:top"><div align = right>'+str(locale.format('%0.2f',sub[0],True))+object.pricelist_id.currency_id.symbol+'</div></td>'\
                  ...
                  '<td width="108px" style="background-color: rgb(245, 245, 245) ; vertical-align:top"><div align = right>'+str(locale.format('%0.2f',line.price_unit,True))+object.pricelist_id.currency_id.symbol+'</div></td>'\
                  '<td width="108px" style="background-color: rgb(245, 245, 245) ; vertical-align:top"><div align = right>'+str(locale.format('%0.2f',line.price_unit * line.product_uom_qty - line.dicount_number,True))+object.pricelist_id.currency_id.symbol+'</div></td>'\
                  '<td width="40px" style="background-color: rgb(245, 245, 245) ; vertical-align:top"><div align = right>'+str(locale.format('%0.2f',total_1,True))+'</div></td>'\
                  '<td width="60px" style="background-color: rgb(245, 245, 245) ; vertical-align:top"><div align = right>'+str(locale.format('%0.2f',sub_1,True))+'</div></td>'\
                  '</tr>'
                unit = [0,]
                total = [0,]
                sub = [0,]
        ...
        return '<table id="view_bom" width="1400px">'\
              ...
              '<th width="325px" colspan="3"><div align = center><font color= white>Cost Price</font></div></th>'\
              '<th width="325px" colspan="3"><div align = center><font color= white>Total</font></div></th>'\
              '<th width="100px" colspan="2"><div align = center><font color= white>Gross Margin(%)</font></div></th>'\
           '</tr>'\
           '<tr align="left" width="100%" height="36px" style="background-color: rgb(238, 76, 140) ;">'\
              ...
              '<th width="108px"><div align = center><font color= white>Total</font></div></th>'\
              '<th width="108px"><div align = center><font color= white>Sub Total</font></div></th>'\
              '<th width="40px"><div align = center><font color= white>Total</font></div></th>'\
              '<th width="60px"><div align = center><font color= white>Sub Total</font></div></th>'\
           '</tr>'\
           +str_line+''\
           '</table></div>'
...
#               '<td align ="center" height= "30px" colspan="1" style="vertical-align:middle;"><div align = right style=" font-size: 13px;">Discount</div></td>'\
#               '<td align ="center" height= "30px" style="background-color: rgb(245, 245, 245); vertical-align:middle;"><div align = right>'+str(locale.format('%0.2f',object.total_discount,True)) +' '+ object.pricelist_id.currency_id.symbol +'</div></td>'\
#               '<td align ="right" height= "30px"><div align = right></div></td>'\
#            '</tr>'\
#            '<tr align="left" width="100%"  height= "30px" style="vertical-align:top;">'\
#               '<td  align ="center" height= "30px" colspan="1" style="vertical-align:middle;"><div align = right style=" font-size: 16px;"><b>Total</b></div></td>'\
#               '<td  align ="right"  height= "30px" colspan="2" style="background-color: rgb(238, 76, 140) ;vertical-align:middle; font-size: 16px;"><div align = right><font color="white"><b>'+str(locale.format('%0.2f',object.amount_total,True))+' '+object.pricelist_id.currency_id.symbol+'</b></font></div></td>'\
#            '</tr>'\
#         '<tr align="left" width="100%" >'\
#               '<td align ="center" colspan="1"><div align = right style=" font-size: 16px;"></div></td>'\
#               '<td align ="right" colspan="2"><div align = right><font color="white"></div></td>'\
#            '</tr>'\
